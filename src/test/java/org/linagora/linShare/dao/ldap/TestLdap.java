...
//	@Test
	public void testExist(){
		...
		Assert.assertTrue(ldapDao.exist("1"));
...
//	@Test
	public void testRetrieveValues(){
		...
		Assert.assertEquals("robert@robert.com", map.get("mail"));
		Assert.assertEquals("Robert", map.get("givenName"));
		Assert.assertEquals("1", map.get("uid"));
	}
