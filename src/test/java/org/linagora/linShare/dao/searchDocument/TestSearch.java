...
@ContextConfiguration(locations={"classpath:springContext-service.xml","classpath:springContext-test.xml",
    "classpath:springContext-datasource.xml", "classpath:springContext-repository.xml","classpath:springContext-jackRabbit.xml","classpath:springContext-dao.xml","classpath:springContext-facade.xml"})
