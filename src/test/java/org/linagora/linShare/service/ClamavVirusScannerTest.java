...
public class ClamavVirusScannerTest {
	...
	public static void setUp() throws Exception {
		...
		String clamavHost = (String) properties.get("virusscanner.clamav.host");
		Integer clamavPort = new Integer((String) properties.get("virusscanner.clamav.port"));
		fileNameToCheck = (String) properties.getProperty("virusscanner.clamav.filetocheck");
	...
	public void checkCommunicationFailed() {
		...
		try {
			...
			wrongVirusScannerService.check(this.getClass().getResourceAsStream("/linShare-test.properties.sample"));
	...
	public void checkSteam() {
		try{
			...
			boolean flag=virusScannerService.check(this.getClass().getResourceAsStream("/linShare-test.properties.sample"));
	...
	public void checkStreamWhenDisabled() {
		...
		try {
			...
			disabledVirusScannerService.check(this.getClass().getResourceAsStream("/linShare-test.properties.sample"));
		} catch (TechnicalException e) {
