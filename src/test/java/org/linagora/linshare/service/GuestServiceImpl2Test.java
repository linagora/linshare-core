...
public class GuestServiceImpl2Test {
	...
	public void setUp() throws Exception {
		...
		johnGuest = guestService.create(john, john, johnGuest, null,null, null);
		...
		janeGuest = guestService.create(jane, jane, janeGuest, null, null, null);
		...
		fooGuest = guestService.create(foo, foo, fooGuest, null, null, null);
