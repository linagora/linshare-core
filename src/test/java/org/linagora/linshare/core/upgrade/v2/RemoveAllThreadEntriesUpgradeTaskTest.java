...
import org.linagora.linshare.core.upgrade.v2_1.RemoveAllThreadEntriesUpgradeTaskImpl;
...
public class RemoveAllThreadEntriesUpgradeTaskTest {
	...
	@Autowired
	@Qualifier("threadEntryRepository")
