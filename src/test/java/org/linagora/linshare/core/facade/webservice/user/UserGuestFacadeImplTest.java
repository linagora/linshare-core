...
import org.linagora.linshare.core.facade.webservice.user.impl.GuestFacadeImpl;
...
/**
 * Unit tests of {@link GuestFacadeImpl} from the package 'User'.
 */
@ExtendWith(MockitoExtension.class)
class UserGuestFacadeImplTest extends AbstractGuestFacadeTest {
	...
	protected GuestFacadeFragment createFacadeImplementation(
		...
		return new TestUserGuestFacade(
				accountService,
				guestService,
				userService,
				passwordService,
	...
	/**
	 * Test implementation of the user GuestFacadeImpl that overrides authentication methods
	 * and implements TestGuestFacade interface
	 */
	private static class TestUserGuestFacade extends GuestFacadeImpl {

		public TestUserGuestFacade(
		...
		@Override
		@Nonnull
		protected User getActor(final Account authUser, final String actorUuid) {
