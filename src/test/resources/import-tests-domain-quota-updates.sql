...
INSERT INTO account(id, mail, account_type, ls_uuid, creation_date, modification_date, role_id, locale, external_mail_locale,
	cmis_locale, enable, password, destroyed, domain_id, purge_step, first_name, last_name, can_upload, comment, restricted, CAN_CREATE_GUEST, inconsistent)
	VALUES (14, 'inconsistent-user1@linshare.org', 2, '412da435-1860-439c-b753-b91a2b13af70', now(), now(), 0, 'en', 'en', 'en', true, null, 0, 2, 'IN_USE', 'inconsistent', 'User1', true, '', false, true, false);
