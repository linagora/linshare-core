...
INSERT INTO entry (id, owner_id, creation_date, modification_date, expiration_date, name, comment, uuid, cmis_sync)
	VALUES (2, 10, now() - 5, now() - 5, now() + 5, 'SE test doc entry name 1', '', 'cb1e7ba6-40db-11e5-9c46-0800271467bb', false);
INSERT INTO share_entry (entry_id, document_entry_id, downloaded, recipient_id, share_entry_group_id)
	VALUES (2, 1, 0, 10, 1);

-- SE
INSERT INTO entry (id, owner_id, creation_date, modification_date, expiration_date, name, comment, uuid, cmis_sync)
	VALUES (3, 10, now() - 5, now() - 5, now() + 5, 'SE test doc entry name 1', '', 'f92aaba0-40db-11e5-9698-0800271467bb', false);
INSERT INTO share_entry (entry_id, document_entry_id, downloaded, recipient_id, share_entry_group_id)
	VALUES (3, 1, 1, 11, 1);
...
INSERT INTO entry (id, owner_id, creation_date, modification_date, expiration_date, name, comment, uuid, cmis_sync)
	VALUES (10, 10, now() - 5, now() - 5, now() + 5, 'ASE test doc entry name 1', '', '9c555037-f447-47bb-99cb-5f46a1409829', false);
...
INSERT INTO entry (id, owner_id, creation_date, modification_date, expiration_date, name, comment, uuid, cmis_sync)
	VALUES (13, 10, now() - 5, now() - 5, now() + 5, 'ASE test doc entry name 4', '', '54f01fc6-41ac-11e5-b057-080027b8274b', false);
INSERT INTO anonymous_share_entry (entry_id, downloaded, document_entry_id, anonymous_url_id, share_entry_group_id)
    VALUES (13, 0, 12, 3, 1 );
...
-- SE
INSERT INTO entry (id, owner_id, creation_date, modification_date, expiration_date, name, comment, uuid, cmis_sync)
	VALUES (5, 10, now() - 5, now() - 5, now() + 5, 'SE test doc entry name 2', '', 'e551db6e-cce1-46bc-b446-6cc10a439dfa', false);
INSERT INTO share_entry (entry_id, document_entry_id, downloaded, recipient_id, share_entry_group_id)
	VALUES (5, 4, 0, 10, 2);

-- SE
INSERT INTO entry (id, owner_id, creation_date, modification_date, expiration_date, name, comment, uuid, cmis_sync)
	VALUES (6, 10, now() - 5, now() - 5, now() + 5, 'SE test doc entry name 2', '', 'f1dcb21b-5b92-4780-8a9b-1c5a4c935177', false);
INSERT INTO share_entry (entry_id, document_entry_id, downloaded, recipient_id, share_entry_group_id)
	VALUES (6, 4, 0, 11, 2);
...
-- SE
INSERT INTO entry (id, owner_id, creation_date, modification_date, expiration_date, name, comment, uuid, cmis_sync)
	VALUES (8, 10, now() - 5, now() - 5, now() + 5, 'SE test doc entry name 3', '', '6ff7b6a4-7935-425c-960e-ff92901992e9', false);
INSERT INTO share_entry (entry_id, document_entry_id, downloaded, recipient_id, share_entry_group_id)
	VALUES (8, 7, 1, 10, 3);

-- SE
INSERT INTO entry (id, owner_id, creation_date, modification_date, expiration_date, name, comment, uuid, cmis_sync)
	VALUES (9, 10, now() - 5, now() - 5, now() + 5, 'SE test doc entry name 3', '', 'ff6465f2-142e-476b-b4aa-11ef9194885e', false);
INSERT INTO share_entry (entry_id, document_entry_id, downloaded, recipient_id, share_entry_group_id)
	VALUES (9, 7, 1, 11, 3);
...
INSERT INTO entry (id, owner_id, creation_date, modification_date, expiration_date, name, comment, uuid, cmis_sync)
	VALUES (11, 10, now() - 5, now() - 5, now() + 5, 'ASE test doc entry name 3', '', 'a11fb104-a695-4aea-bc8e-56fb8bdf24e5', false);
INSERT INTO anonymous_share_entry (entry_id, downloaded, document_entry_id, anonymous_url_id, share_entry_group_id)
	VALUES (11, 0, 7, 2, 5);

-- SE
INSERT INTO entry (id, owner_id, creation_date, modification_date, expiration_date, name, comment, uuid, cmis_sync)
	VALUES (14, 10, now() - 5, now() - 5, now() + 5, 'SE test doc entry name 3', '', '7a167dce-4277-11e5-84ee-0800271467bb', false);
INSERT INTO share_entry (entry_id, document_entry_id, downloaded, recipient_id, share_entry_group_id)
	VALUES (14, 7, 1, 11, 5);
