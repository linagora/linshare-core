...
CREATE TABLE quota (
  ...
  uuid                           varchar(255) NOT NULL UNIQUE,
  quota                          int8 NOT NULL,
  quota_override                 bool DEFAULT 'false' NOT NULL,
  quota_default                  int8 NOT NULL,
  quota_default_override         bool DEFAULT 'false' NOT NULL,
  quota_warning                  int8 NOT NULL,
  current_value                  int8 NOT NULL,
  last_value                     int8 NOT NULL,
  max_file_size                  int8,
  default_max_file_size          int8,
  default_max_file_size_override bool DEFAULT 'false',
  default_account_value          int8,
  default_account_value_override bool DEFAULT 'false',
  creation_date                  timestamp(6) NOT NULL,
  modification_date              timestamp(6) NOT NULL,
