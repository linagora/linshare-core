...
CREATE TABLE functionality_integer (
  ...
  unlimited_value_used    bool DEFAULT 'false' NOT NULL,
...
CREATE UNIQUE INDEX moderator_uuid_index
  ON moderator (uuid);
CREATE UNIQUE INDEX moderator_account_id_guest_id
  ON moderator (account_id, guest_id);
...
ALTER TABLE contact_provider ADD CONSTRAINT FKcontact_pr166740 FOREIGN KEY (ldap_connection_id) REFERENCES remote_server (id);
