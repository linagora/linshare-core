...
<li style="color:#787878;font-size:10px;margin-top:10px;"  th:each="shareLink : ${arrayFileLinks}" >
  ...
  <a target="_blank" style="color:#1294dc;text-decoration:none;font-size:13px" href="">
    <span align="left" style="display: inline-block; width: 96%;"  data-th-utext="${shareLink.name}" th:href="@{${shareLink.href}}">
test-file.jpg</span></a>
 ...
 <th:block  th:each="recipientData: ${shareLink.shares}">
      <li style="color:#787878;font-size:15px"  data-th-if="(${!recipientData.downloaded})" >
   ...
   <li style="color:#00b800;font-size:15px" th:each="recipientData: ${shareLink.shares}" data-th-if="(${recipientData.downloaded})">
        <span style="color:#7f7f7f;font-size:13px;"  data-th-utext="${recipientData.firstName +'' '' + recipientData.lastName}"
           data-th-if="(${!#strings.isEmpty(recipientData.lastName)})">Abey CUREY </span>
      <span style="color:#7f7f7f;font-size:13px;" data-th-utext="${recipientData.mail}" 
           data-th-if="(${#strings.isEmpty(recipientData.lastName)})">able.cornell@linshare.com </span>
...
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (6, 1, 'Shared document was deleted', true, 5, '[( #{subject(${shareOwner.firstName +'' ''+ shareOwner.lastName},${share.name})})]', '<!DOCTYPE html>
<html xmlns:th="http://www.thymeleaf.org">
<head  data-th-replace="layout :: header"></head>
<body>
<div th:replace="layout :: email_base(upperMainContentArea = ~{::#main-content},bottomSecondaryContentArea = ~{::#secondary-content})">
...
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (33, 1, 'a', true, 32, '[# th:if="${documentsCount} > 1"] 
...
undownloadedDateTitle =Reminder date of the Non-downloaded files');
...
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (7, 1, 'Shared document is soon to be outdated', true, 6, '[( #{subject(${share.name})})]', '<!DOCTYPE html>
<html xmlns:th="http://www.thymeleaf.org">
<head data-th-replace="layout :: header"></head>
<body>
<div
...
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (3, 1, 'New guest', true, 2, '[( #{subject(${creator.firstName +'' ''+ creator.lastName}, #{productName})})]', '<!DOCTYPE html>
<html xmlns:th="http://www.thymeleaf.org">
<head  data-th-replace="layout :: header"></head>
<body>
<div th:replace="layout :: email_base(upperMainContentArea = ~{::#main-content},bottomSecondaryContentArea = ~{::#secondary-content})">
...
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (19, 1, 'Upload request acknowledgement', true, 18, '[( #{subject(${requestRecipient.mail},${document.name},${mailSubject})})]', '<!DOCTYPE html>
<html xmlns:th="http://www.thymeleaf.org">
<head  data-th-replace="layout :: header"></head>
<body>
<div th:replace="layout :: email_base(upperMainContentArea = ~{::#main-content},bottomSecondaryContentArea = ~{::#secondary-content})">
...
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (4, 1, 'Password reset', true, 3, '[( #{subject})]', '<!DOCTYPE html>
<html xmlns:th="http://www.thymeleaf.org">
<head  data-th-replace="layout :: header"></head>
<body>
<div th:replace="layout :: email_base(upperMainContentArea = ~{::#main-content},bottomSecondaryContentArea = ~{::#secondary-content})">
...
userNameTitle= Username');
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (25, 1, 'Upload request closed', true, 24, '[( #{subject(${requestRecipient.mail},${mailSubject})})]', '<!DOCTYPE html>
<html xmlns:th="http://www.thymeleaf.org">
<head data-th-replace="layout :: header"></head>
<body>
<div
...
uploadedOverTotal  = {0} / {1} files');
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (28, 1, 'Upload request error: no space left', true, 27, '[( #{subject(${requestRecipient.mail},${mailSubject})})]', '<!DOCTYPE html>
<html xmlns:th="http://www.thymeleaf.org">
<head data-th-replace="layout :: header"></head>
<body>
<div
...
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (23, 1, 'Upload request is expired', true, 22, '[( #{subject(${mailSubject})})]
[# th:if="${warnOwner}"] 
           [( #{subjectForOwner})]
       [/]
        [# th:if="${!warnOwner}"] 
