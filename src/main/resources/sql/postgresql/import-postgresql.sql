...
${body}
${footer}
', now(), now(), 'db044da6-89d1-11e3-b6a9-5404a683a462', true, true, NULL, NULL);
INSERT INTO mail_layout (id, domain_abstract_id, description, visible, layout, creation_date, modification_date, uuid, plaintext, readonly, messages_french, messages_english) VALUES (1, 1, 'Default HTML layout', true, '<!DOCTYPE html>
...
</html>', now(), now(), '15044750-89d1-11e3-8d50-5404a683a462', false, true, 'productName=LinShare
productCompagny=Linagora', 'productName=LinShare
productCompagny=Linagora');



INSERT INTO mail_config (id, mail_layout_html_id, domain_abstract_id, name, visible, mail_layout_text_id, uuid, creation_date, modification_date) VALUES (1, 1, 1, 'Default mail config', true, 2, '946b190d-4c95-485f-bfe6-d288a2de1edd', now(), now());
...
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, plaintext, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (28, 1, 'Upload request error: no space left', true, 27, 'A user ${actorRepresentation} has just tried to upload a file but server had no space left', '<strong>${firstName} ${lastName}</strong> has just tried to upload in the upload request: ${subject}<br/>${body}<br>Please free space and notify the recipient to retry is upload<br/><br/>', '48fee30b-b2d3-4f85-b9ee-22044f9dbb4d', false, now(), now(), true, NULL, NULL);
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, plaintext, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (30, 1, 'Upload request file deleted', true, 29, 'A user ${actorRepresentation} has deleted a file for upload request: ${subject}', '<strong>${firstName} ${lastName}</strong> has deleted a file.<br/>File name: ${fileName}<br/>Deletion date: ${deleteDate}<br/>File size: ${fileSize}<br/><br/>', '88b90304-e9c9-11e4-b6b4-5404a6202d2c', false, now(), now(), true, NULL, NULL);
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, plaintext, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (31, 1, 'Share creation acknowledgement', true, 30, '[SHARE ACKNOWLEDGEMENT] Shared on ${date}.', 'You just shared ${fileNumber} file(s), on the ${creationDate}, expiring the ${expirationDate}, with :<br/><ul>${recipientNames}</ul><br/>The list of your files is : <ul>${documentNames}</ul><br/>', '01e0ac2e-f7ba-11e4-901b-08002722e7b1', false, now(), now(), true, NULL, NULL);
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, plaintext, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (32, 1, 'Share creation acknowledgement', true, 31, '[SHARE ACKNOWLEDGEMENT] ${subject}. Shared on ${date}.', 'You just shared ${fileNumber} file(s), on the ${creationDate}, expiring the ${expirationDate}, with :<br/><ul>${recipientNames}</ul><br/>Your original message was:<br/><i>${message}</i><br/><br/>The list of your files is : <ul>${documentNames}</ul><br/>', '2209b038-e1e7-11e4-8d2d-3b2a506425c0', false, now(), now(), true, NULL, NULL);
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, plaintext, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (33, 1, 'Undownloaded shared documents alert', true, 32, '[Undownloaded shared documents alert] ${subject} Shared on ${date}.', 'Please find below the resume of the share you made on ${creationDate} with initial expiration date on ${expirationDate}.<br /> List of documents : <br /><table style="border-collapse: collapse;">${shareInfo}</table><br/>', 'eb291876-53fc-419b-831b-53a480399f7c', false, now(), now(), true, NULL, NULL);
INSERT INTO mail_content (id, domain_abstract_id, description, visible, mail_content_type, subject, body, uuid, plaintext, creation_date, modification_date, readonly, messages_french, messages_english) VALUES (9, 1, 'New sharing', true, 8, 'A user ${actorRepresentation} has just made a file available to you!', '<!DOCTYPE html>
<html xmlns:th="http://www.thymeleaf.org">
<header>
     <div data-th-insert="layout :: header"></div>
</header>
...
<br />
 ...
 </html>', '250e4572-7bb9-4735-84ff-6a8af93e3a42', false, now(), now(), true, NULL, NULL);
...
INSERT INTO mail_footer (id, domain_abstract_id, description, visible, footer, creation_date, modification_date, uuid, plaintext, readonly, messages_french, messages_english) VALUES (2, 1, 'footer', true, 'LinShare - http://linshare.org - THE Secure, Open-Source File Sharing Tool', now(), now(), '83e756e8-8cf7-11e3-b493-5404a683a462', true, true, NULL, NULL);
INSERT INTO mail_footer (id, domain_abstract_id, description, visible, footer, creation_date, modification_date, uuid, plaintext, readonly, messages_french, messages_english) VALUES (1, 1, 'footer html', true, '<!DOCTYPE html>
<html xmlns:th="http://www.thymeleaf.org">
  <body>
 ...
 </html>', now(), now(), 'e85f4a22-8cf2-11e3-8a7a-5404a683a462', false, true, '', '');
