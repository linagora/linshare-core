...
-- MyDomain QUOTA
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (2, '164783e8-b9d1-11e5-87e9-bfc0aac925c2', NOW(), NOW(), NOW(), null, null, 0,0, 2, null, 1, 1099511627776, 1045824536576, 10737418240 null, 'DOMAIN_QUOTA');

INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (3, '37226d66-b9d2-11e5-b4d8-f7b730449724', NOW(), NOW(), NOW(), 2, null, 0,0, 2, null, 1, 1099511627776, 1045824536576, 10737418240 'USER', 'CONTAINER_QUOTA');

INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (4, '6a442450-b9d2-11e5-8c67-5b2367500fc4', NOW(), NOW(), NOW(), 2, null, 0,0, 2, null, 1, 1099511627776, 1045824536576, 10737418240 'WORK_GROUP', 'CONTAINER_QUOTA');

-- MySubDomain QUOTA
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (5, 'b69b9d1a-b9d2-11e5-aab9-e337a9ab2b58', NOW(), NOW(), NOW(), null, null, 0,0, 3, null, 2, 1099511627776, 1045824536576, 10737418240 null, 'DOMAIN_QUOTA');

INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (6, 'f8733bd0-b9d2-11e5-a247-2b9505cfdddf', NOW(), NOW(), NOW(), 5, null, 0,0, 3, null, 2, 1099511627776, 1045824536576, 10737418240 'USER', 'CONTAINER_QUOTA');

INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (7, '002310d0-b9d3-11e5-9413-d3f63c53e650', NOW(), NOW(), NOW(), 5, null, 0,0, 3, null, 2, 1099511627776, 1045824536576, 10737418240 'WORK_GROUP', 'CONTAINER_QUOTA');

-- GuestDomain QUOTA
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (8, '0b866494-b9d4-11e5-be35-afca154efca0', NOW(), NOW(), NOW(), null, null, 0,0, 4, null, 2, 1099511627776, 1045824536576, 10737418240 null, 'DOMAIN_QUOTA');

INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (9, '1515e6e2-b9d4-11e5-997e-0b5792ea886a', NOW(), NOW(), NOW(), 8, null, 0,0, 4, null, 2, 1099511627776, 1045824536576, 10737418240 'USER', 'CONTAINER_QUOTA');

INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (10, '1f468522-b9d4-11e5-916d-a713a67dd225', NOW(), NOW(), NOW(), 8, null, 0,0, 4, null, 2, 1099511627776, 1045824536576, 10737418240 'WORK_GROUP', 'CONTAINER_QUOTA');
...
VALUES (43, '1f468522-b9d4-11e5-916d-a713a67dd226', NOW(), NOW(), NOW(), null, 6, 0,0, 3, 50, 2, 1099511627776, 1045824536576, 100000000000, null, 'ACCOUNT_QUOTA');
