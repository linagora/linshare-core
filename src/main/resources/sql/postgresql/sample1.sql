...
INSERT INTO account(id, mail, account_type, ls_uuid, creation_date, modification_date, role_id, mail_locale,cmis_locale, enable, password, destroyed, domain_id, first_name, last_name, can_upload, comment, restricted, can_create_guest)
	VALUES (40, 'undefined.technical_account@int6.linshare.dev', 4, 'fff38827-490a-4654-86a6-57b61611b42d', now(),now(), 4, 'en','en', true, 'JYRd2THzjEqTGYq3gjzUh2UBso8=', 0, 1, null, 'Technical Account for test', false, '', false, false);
...
-- amy.wolsh
INSERT INTO account(id, mail, account_type, ls_uuid, creation_date, modification_date, role_id, mail_locale,cmis_locale, enable, password, destroyed, domain_id, first_name, last_name, can_upload, comment, restricted, can_create_guest)
	VALUES (50, 'amy.wolsh@int6.linshare.dev', 2, '9a9ece25-7a0e-4d75-bb55-d4070e25e1e1', current_timestamp(3), current_timestamp(3), 0, 'en','fr', true, 0, 3, 'Amy', 'Wolsh', true, '', false, true);
