...
-- Users
-- bart simpson
INSERT INTO account(id, account_type, ls_uuid, creation_date, modification_date, role_id, locale, external_mail_locale, enable, destroyed, domain_id, purge_step) VALUES (50, 2, '9a9ece25-7a0e-4d75-bb55-d4070e25e1e1', current_date, current_date, 0, 'fr', 'en', true, false, 3, 0);
...
INSERT INTO account(id, account_type, ls_uuid, creation_date, modification_date, role_id, locale, external_mail_locale, enable, destroyed, domain_id, owner_id , password, purge_step) VALUES (53, 3, 'fa2cab19-2cd7-44f5-96f6-418455899d3e', current_date, current_date, 0, 'fr', 'fr', true, false, 4, 50 , 'OsFTxoUjd62imwHnaV/4zQfrJ5s=', 0);
...
-- Thread : projet : RATP
INSERT INTO account(id, account_type, ls_uuid, creation_date, modification_date, role_id, locale, external_mail_locale, enable, destroyed, domain_id, purge_step) VALUES (51, 5, '9806de10-ed0b-11e1-877a-5404a6202d2c', current_date, current_date, 0, 'fr', 'fr', true, false, 1, 0);
INSERT INTO thread (account_id, name) VALUES (51, 'RATP');
-- Thread : projet : 3MI
INSERT INTO account(id, account_type, ls_uuid, creation_date, modification_date, role_id, locale, external_mail_locale, enable, destroyed, domain_id, purge_step) VALUES (52, 5, '34544580-f0ec-11e1-a62a-080027c0eef0', current_date, current_date, 0, 'fr', 'fr', true, false, 1, 0);
INSERT INTO thread (account_id, name) VALUES (52, 'Ministère de l''intérieur');
-- Thread : projet : Test Thread
INSERT INTO account(id, account_type, ls_uuid, creation_date, modification_date, role_id, locale, external_mail_locale, enable, destroyed, domain_id, purge_step) VALUES (54, 5, 'c4570914-d004-4506-8abf-04527f342e88', current_date, current_date, 0, 'en', 'en', true, false, 1, 0);
