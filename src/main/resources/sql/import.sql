...
INSERT INTO linshare_user(user_id, user_type_id, login, first_name, last_name, mail, creation_date, role_id, password, expiry_date, can_upload)   VALUES (1, 0, 'root@localhost.localdomain', 'admin', 'LinShare', 'root@localhost.localdomain', '01-01-2009', 1, 'JYRd2THzjEqTGYq3gjzUh2UBso8=', '01-01-2109', 'true');
INSERT INTO linshare_user(user_id, user_type_id, login, first_name, last_name, mail, creation_date, role_id, password, expiry_date, can_upload)   VALUES (2, 0, 'system', '', '', 'system@localhost', '01-01-2009', 2, 'JYRd2THzjEqTGYq3gjzUh2UBso8=', '01-01-2109', 'true');
