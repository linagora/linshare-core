...
INSERT INTO linshare_welcome_texts (messages_configuration_id, welcome_text, user_type_id, language_id) VALUES (1, E'Welcome to LinShare, the Open Source secure files sharing system.', 0, 0);


-- Welcome to LinShare, the Open Source secure files sharing system.
INSERT INTO linshare_welcome_texts (messages_configuration_id, welcome_text, user_type_id, language_id) VALUES (1, E'Welcome to LinShare, the Open Source secure files sharing system.', 1, 0);
...
-- Welcome to LinShare, the Open Source secure files sharing system
INSERT INTO linshare_welcome_texts (messages_configuration_id, welcome_text, user_type_id, language_id) VALUES (1, E'Bienvenue dans LinShare, le système Open Source de partage de fichiers sécurisé.', 0, 1);


-- Welcome to LinShare, the Open Source secure files sharing system.
INSERT INTO linshare_welcome_texts (messages_configuration_id, welcome_text, user_type_id, language_id) VALUES (1, E'Bienvenue dans LinShare, le système Open Source de partage de fichiers sécurisé.', 1, 1);
...
-- Welcome to LinShare, the Open Source secure files sharing system
INSERT INTO linshare_welcome_texts (messages_configuration_id, welcome_text, user_type_id, language_id) VALUES (1, E'Welkom bij LinShare, het Open Source-systeem om grote bestanden te delen.', 0, 2);


-- Welcome to LinShare, the Open Source secure files sharing system.
INSERT INTO linshare_welcome_texts (messages_configuration_id, welcome_text, user_type_id, language_id) VALUES (1, E'Welkom bij LinShare, het Open Source-systeem om grote bestanden te delen.', 1, 2);
