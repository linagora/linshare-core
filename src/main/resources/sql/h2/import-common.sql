...
INSERT INTO mail_content (id, uuid, domain_abstract_id, language, mail_content_type, visible, plaintext, modification_date, creation_date, greetings, name, subject, body, enable_as) VALUES  (33, 'eb291876-53fc-419b-831b-53a480399f7c', 1, 0, 32, true, false, now(), now(), E'Bonjour ${firstName} ${lastName},<br/><br/>', E'Accusé de non téléchargement de fichiers', E'[Accusé de Non Télécharchement] ${subject}. Partagé le ${date}.', E'A ce jour, aucun des ${number} fichier(s) que vous avez mis en partage na été téléchargé par les destinataires. &nbsp;Liste des destinataires: <ul>${recipientNames}</ul><br/>Liste des documents :<ul>${documentNames}</ul><br/>', false);
