...
INSERT INTO account(id, account_type, ls_uuid, creation_date, modification_date, role_id, locale, external_mail_locale, enable, password, destroyed, domain_id, purge_step) VALUES (1, 6, 'root@localhost.localdomain', current_date(), current_date(), 3, 'en', 'en', true, 'JYRd2THzjEqTGYq3gjzUh2UBso8=', false, 1, 'IN_USE');
...
-- system account :
INSERT INTO account(id, account_type, ls_uuid, creation_date, modification_date, role_id, locale, external_mail_locale, enable, destroyed, domain_id, purge_step) VALUES (2, 7, 'system', current_date(), current_date(), 3, 'en', 'en', true, false, 1, 'IN_USE');

-- system account for upload-request:
INSERT INTO account(id, account_type, ls_uuid, creation_date, modification_date, role_id, locale, external_mail_locale, enable, destroyed, domain_id, purge_step) VALUES (3, 7, 'system-account-uploadrequest', current_date(), current_date(), 3, 'en', 'en', true, false, 1, 'IN_USE');
