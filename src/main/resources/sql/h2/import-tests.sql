...
-- max_file_size : 10 Go
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, max_file_size, container_type, quota_type) VALUES (2, 'd273f30c-825c-4379-bd21-470b0cb40da6', NOW(), NOW(), NOW(), null, null, 0, 0, 2, null, 1, 1099511627776, 1045824536576, 10737418240, null, 'DOMAIN_QUOTA');
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, max_file_size, container_type, quota_type) VALUES (5, 'daa310bc-6b94-4ddc-855b-f9ef1a653f15', NOW(), NOW(), NOW(), 2, null, 0, 0, 2, null, 1, 1099511627776, 1045824536576, 10737418240, 'USER', 'CONTAINER_QUOTA');
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, max_file_size, container_type, quota_type) VALUES (6, 'd91c2675-460f-4f31-b0cd-1eb82e2900ee', NOW(), NOW(), NOW(), 2, null, 0, 0, 2, null, 1, 1099511627776, 1045824536576, 10737418240, 'WORK_GROUP', 'CONTAINER_QUOTA');
...
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, max_file_size, container_type, quota_type) VALUES (3, '8aa8beb0-5640-488e-8854-620ef6686aa8', NOW(), NOW(), NOW(), null, null, 0, 0, 3, null, 1, 1099511627776, 1045824536576, 10737418240, null, 'DOMAIN_QUOTA');
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, max_file_size, container_type, quota_type) VALUES (7, '5b60eeec-973f-4086-a021-76b95bfaaf85', NOW(), NOW(), NOW(), 3, null, 0, 0, 3, null, 2, 1099511627776, 1045824536576, 10737418240, 'USER', 'CONTAINER_QUOTA');
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, max_file_size, container_type, quota_type) VALUES (8, '67d57eed-c5f9-4938-89a7-139d1bd7b32b', NOW(), NOW(), NOW(), 3, null, 0, 0, 3, null, 2, 1099511627776, 1045824536576, 10737418240, 'WORK_GROUP', 'CONTAINER_QUOTA');
...
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, max_file_size, container_type, quota_type) VALUES (4, '7b39a7ca-f0e8-4e6d-9d1a-3b3d076d86ea', NOW(), NOW(), NOW(), null, null, 0, 0, 4, null, 1,1099511627776, 1045824536576, 10737418240, null, 'DOMAIN_QUOTA');
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, max_file_size, container_type, quota_type) VALUES (9, '6a7d9884-7427-46b7-9142-0625ee6ad906', NOW(), NOW(), NOW(), 4, null, 0, 0, 4, null, 2, 1099511627776, 1045824536576, 10737418240, 'USER', 'CONTAINER_QUOTA');
