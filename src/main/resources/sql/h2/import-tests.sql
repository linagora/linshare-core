...
INSERT INTO domain_abstract(id, type , uuid, label, enable, template, description, default_role, default_locale, used_space, user_provider_id, domain_policy_id, parent_id, auth_show_order, mailconfig_id, welcome_messages_id) VALUES (2, 1, 'MyDomain', 'MyDomain', true, false, 'a simple description', 0, 'en', 0, null, 1, 1, 2, null, 1);
-- quota : 1 To, quota_warning : 950 Go
-- file_size_max : 10 Go
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (2, 'd273f30c-825c-4379-bd21-470b0cb40da6', NOW(), NOW(), NOW(), null, null, 0, 0, 2, null, 1, 1099511627776, 1045824536576, 10737418240, null, 'DOMAIN_QUOTA');
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (5, 'daa310bc-6b94-4ddc-855b-f9ef1a653f15', NOW(), NOW(), NOW(), 2, null, 0, 0, 2, null, 1, 1099511627776, 1045824536576, 10737418240, 'USER', 'CONTAINER_QUOTA');
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (6, 'd91c2675-460f-4f31-b0cd-1eb82e2900ee', NOW(), NOW(), NOW(), 2, null, 0, 0, 2, null, 1, 1099511627776, 1045824536576, 10737418240, 'WORK_GROUP', 'CONTAINER_QUOTA');


-- Sub domain (example domain)
INSERT INTO domain_abstract(id, type , uuid, label, enable, template, description, default_role, default_locale, used_space, user_provider_id, domain_policy_id, parent_id, auth_show_order, mailconfig_id, welcome_messages_id) VALUES (3, 2, 'MySubDomain', 'MySubDomain', true, false, 'a simple description', 0, 'en', 0, 50, 1, 2, 3, null, 1);
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (3, '8aa8beb0-5640-488e-8854-620ef6686aa8', NOW(), NOW(), NOW(), null, null, 0, 0, 3, null, 1, 1099511627776, 1045824536576, 10737418240, null, 'DOMAIN_QUOTA');
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (7, '5b60eeec-973f-4086-a021-76b95bfaaf85', NOW(), NOW(), NOW(), 3, null, 0, 0, 3, null, 2, 1099511627776, 1045824536576, 10737418240, 'USER', 'CONTAINER_QUOTA');
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (8, '67d57eed-c5f9-4938-89a7-139d1bd7b32b', NOW(), NOW(), NOW(), 3, null, 0, 0, 3, null, 2, 1099511627776, 1045824536576, 10737418240, 'WORK_GROUP', 'CONTAINER_QUOTA');


-- Guest domain (example domain)
INSERT INTO domain_abstract(id, type , uuid, label, enable, template, description, default_role, default_locale, used_space, user_provider_id, domain_policy_id, parent_id, auth_show_order, mailconfig_id, welcome_messages_id) VALUES (4, 3, 'GuestDomain', 'GuestDomain', true, false, 'a simple description', 0, 'en', 0, null, 1, 2, 4, null, 1);
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (4, '7b39a7ca-f0e8-4e6d-9d1a-3b3d076d86ea', NOW(), NOW(), NOW(), null, null, 0, 0, 4, null, 1,1099511627776, 1045824536576, 10737418240, null, 'DOMAIN_QUOTA');
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (9, '6a7d9884-7427-46b7-9142-0625ee6ad906', NOW(), NOW(), NOW(), 4, null, 0, 0, 4, null, 2, 1099511627776, 1045824536576, 10737418240, 'USER', 'CONTAINER_QUOTA');
INSERT INTO quota(id, uuid, creation_date, modification_date, batch_modification_date, quota_domain_id, quota_container_id, current_value, last_value, domain_id, account_id, domain_parent_id, quota, quota_warning, file_size_max, container_type, quota_type) VALUES (10, 'd53ce127-0d22-47c1-96c4-3a3d308ac8b7', NOW(), NOW(), NOW(), 4, null, 0, 0, 4, null, 2, 1099511627776, 1045824536576, 10737418240, 'WORK_GROUP', 'CONTAINER_QUOTA');
...
INSERT INTO domain_abstract(id, type , uuid, label, enable, template, description, default_role, default_locale, used_space, user_provider_id, domain_policy_id, parent_id, welcome_messages_id) VALUES (100001, 0, 'TEST_Domain-0', 'TEST_Domain-0', true, false, 'The root test application domain', 3, 'en', 0, null, 100001, null, 1);
-- id : 100001

-- topDomainName
-- id : 100002
INSERT INTO domain_abstract(id, type , uuid, label, enable, template, description, default_role, default_locale, used_space, user_provider_id, domain_policy_id, parent_id, auth_show_order, welcome_messages_id) VALUES (100002, 1, 'TEST_Domain-0-1', 'TEST_Domain-0-1 (Topdomain)', true, false, 'a simple description', 0, 'en', 0, null, 100001, 100001, 2, 1);

-- topDomainName2
-- id : 100003
INSERT INTO domain_abstract(id, type , uuid, label, enable, template, description, default_role, default_locale, used_space, user_provider_id, domain_policy_id, parent_id, auth_show_order, welcome_messages_id) VALUES (100003, 1, 'TEST_Domain-0-2', 'TEST_Domain-0-2 (Topdomain)', true, false, 'a simple description', 0, 'en', 0, null, 100001, 100001, 3, 1);

-- subDomainName1
-- id : 100004
INSERT INTO domain_abstract(id, type , uuid, label, enable, template, description, default_role, default_locale, used_space, user_provider_id, domain_policy_id, parent_id, auth_show_order, welcome_messages_id) VALUES (100004, 2, 'TEST_Domain-0-1-1', 'TEST_Domain-0-1-1 (Subdomain)', true, false, 'a simple description', 0, 'en', 0, null, 100001, 100002, 4, 1);

-- subDomainName2
-- id : 100005
INSERT INTO domain_abstract(id, type , uuid, label, enable, template, description, default_role, default_locale, used_space, user_provider_id, domain_policy_id, parent_id, auth_show_order, welcome_messages_id) VALUES (100005, 2, 'TEST_Domain-0-1-2', 'TEST_Domain-0-1-2 (Subdomain)', true, false, 'a simple description', 0, 'en', 0, null, 100001, 100002, 5, 1);


-- Guest domain (example domain)
-- id : 100006
INSERT INTO domain_abstract(id, type , uuid, label, enable, template, description, default_role, default_locale, used_space, user_provider_id, domain_policy_id, parent_id, auth_show_order, welcome_messages_id) VALUES (100006, 3, 'guestDomainName1', 'guestDomainName1 (GuestDomain)', true, false, 'a simple description', 0, 'en', 0, null, 100001, 100002, 6, 1);
