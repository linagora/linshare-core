-- ldap connection 
INSERT INTO remote_server(id, uuid, server_type, label, provider_url, security_auth, security_principal, security_credentials, creation_date, modification_date) VALUES (50, 'a9b2058f-811f-44b7-8fe5-7a51961eb098', 'LDAP', 'baseLDAP', 'ldap://localhost:33389', 'simple', null, null, now(), now());
