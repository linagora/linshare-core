...
messages_french= '
	...
	beginingMainMsg= Pour des raisons de sécurité où sur votre demande un nouveau mot de passe pour accéder à votre partage a été généré.
...
messages_english= '
	...
	beginingMainMsg= For a security reasons or on your request a new password was generated.
