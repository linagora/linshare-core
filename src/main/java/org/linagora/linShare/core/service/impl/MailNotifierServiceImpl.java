    ...
    public void sendNotification(String fromUser, String recipient, String subject, String htmlContent, String textContent) {
       ...
       // get the mail session
        ...
        MimeMessage messageMim = new MimeMessage(session);
            ...
            messageMim.setFrom(new InternetAddress(fromUser));
 	      ...
 	      alt_bp1.setDataHandler(new DataHandler(new ByteArrayDataSource(textContent,"text/plain")));
	      mp.addBodyPart(alt_bp1); 
          
	       
	      //BodyPart 2 
	      //content type is multipart/related
	      //A multipart/related is used to indicate that message parts should not be considered individually but rather
	      //as parts of an aggregate whole. The message consists of a root part (by default, the first) which reference other parts inline,
