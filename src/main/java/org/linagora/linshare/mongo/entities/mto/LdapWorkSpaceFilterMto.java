...
public class LdapWorkSpaceFilterMto extends AbstractWorkSpaceFilterMto {
	...
	public LdapWorkSpaceFilterMto() {
		super();
	}

	public LdapWorkSpaceFilterMto(LdapWorkSpaceFilter workSpaceFilter) {
		super(workSpaceFilter);
		this.searchAllGroupsQuery = workSpaceFilter.getSearchAllGroupsQuery();
		this.searchGroupQuery = workSpaceFilter.getSearchGroupQuery();
		this.groupPrefix = workSpaceFilter.getGroupPrefix();
		this.searchPageSize = workSpaceFilter.getSearchPageSize();
		Map<String, LdapAttribute> attributes = workSpaceFilter.getAttributes();
	...
	public String toString() {
		return "LdapWorkSpaceFilterMto [uuid=" + uuid + ", label=" + label + ", type=" + type + "]";
	}
}
