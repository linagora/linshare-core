...
public class DriveFilterAuditLogEntry extends AuditLogEntryAdmin {
	...
	private AbstractDriveFilterMto resource;

	private AbstractDriveFilterMto resourceUpdated;

	protected DriveFilterAuditLogEntry() {
		super();
	}
	...
	public void setResource(AbstractDriveFilterMto resource) {
		this.resource = resource;
	}

	public AbstractDriveFilterMto getResourceUpdated() {
		return resourceUpdated;
	}

	public void setResourceUpdated(AbstractDriveFilterMto resourceUpdated) {
