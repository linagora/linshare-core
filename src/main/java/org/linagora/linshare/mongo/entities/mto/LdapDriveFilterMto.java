...
public class LdapDriveFilterMto extends AbstractDriveFilterMto {
	...
	public LdapDriveFilterMto(LdapDriveFilter driveFilter) {
		...
		this.searchPageSize = driveFilter.getSearchPageSize();
		Map<String, LdapAttribute> attributes = driveFilter.getAttributes();
	...
	public String toString() {
		return "LdapDriveFilterMto [uuid=" + uuid + ", label=" + label + ", type=" + type + "]";
	}
}
