...
public enum BusinessErrorCode implements ErrorCode {
	...
	SHARED_SPACE_NODE_ALREADY_EXISTS(50003,Status.BAD_REQUEST),
	SHARED_SPACE_NODE_NOT_FOUND(50004,Status.NOT_FOUND),
	SHARED_SPACE_NODE_FORBIDDEN(50005, Status.FORBIDDEN),
