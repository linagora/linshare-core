...
public enum BusinessErrorCode implements ErrorCode {
	...
	NOT_IMPLEMENTED_YET(1003, Status.NOT_IMPLEMENTED),
	CONFLICT(1004, Status.CONFLICT),

	BATCH_FAILURE(1005, Status.INTERNAL_SERVER_ERROR),
	...
	GUEST_CONVERSION_DISABLED(2211, Status.FORBIDDEN),
	GUEST_CONVERSION_FAILED(2212, Status.FORBIDDEN),
	...
	REMOTE_SERVER_NOT_FOUND(13004, Status.NOT_FOUND),
	...
	REMOTE_SERVER_STILL_IN_USE(13017, Status.FORBIDDEN),
	...
	DOMAIN_FORBIDDEN(13021, Status.FORBIDDEN),
	...
	FUNCTIONALITY_GUEST_CONTACT_LISTS_DISABLED(14007, Status.FORBIDDEN),
	FUNCTIONALITY_GUEST_CONTACTS_DISABLED(14008, Status.FORBIDDEN),
	FUNCTIONALITY_GUESTS__HIDE_MEMBERS_DISABLED(14009, Status.FORBIDDEN),
	HIDE_MEMBERS_SHOULD_FALSE_WHEN_DELEGATION_DISABLED(14010, Status.FORBIDDEN),
	...
	CONTACT_LIST_FORBIDDEN(25004, Status.FORBIDDEN),
	INVALID_CONTACT_LIST(25005, Status.BAD_REQUEST),
	FAILED_DELETE_ACCOUNT_CONTACT_LISTS(25006),
	ACCOUNT_CONTACT_LIST_NOT_FOUND(25007),
	...
	WORK_GROUP_NODE_LIST_FORBIDDEN(26012, Status.FORBIDDEN),

	WORKSPACE_ALREADY_EXISTS(50013,Status.BAD_REQUEST),
	WORKSPACE_NOT_FOUND(50014,Status.NOT_FOUND),
	WORKSPACE_FORBIDDEN(50015, Status.FORBIDDEN),
	WORKSPACE_LIMIT_REACHED(50016, Status.FORBIDDEN),
	...
	WORK_GROUP_LIMIT_REACHED(55508, Status.FORBIDDEN),
	...
	GUEST_MODERATOR_CANNOT_CREATE(28413, Status.FORBIDDEN),
	GUEST_MODERATOR_CANNOT_UPDATE(28414, Status.FORBIDDEN),
	GUEST_MODERATOR_CANNOT_DELETE(28415, Status.FORBIDDEN),
	GUEST_MODERATOR_CANNOT_FIND(28416, Status.NOT_FOUND),
	GUEST_MODERATORS_CANNOT_GET(28417, Status.FORBIDDEN),
	GUEST_MODERATOR_ALREADY_EXISTS(28418, Status.BAD_REQUEST),
	GUEST_MODERATOR_CANNOT_GET(28419, Status.FORBIDDEN),
	GUEST_MODERATOR_WRONG(28420, Status.FORBIDDEN),
	...
	UPLOAD_REQUEST_LIMIT_REACHED(31416, Status.FORBIDDEN),
	...
	WELCOME_MESSAGES_ASSIGNED(36006, Status.BAD_REQUEST),

	USER_PROVIDER_NOT_FOUND(38000, Status.NOT_FOUND),
	USER_PROVIDER_UNSUPPORTED_TYPE(38001, Status.BAD_REQUEST),
	USER_PROVIDER_ALREADY_EXIST(38002, Status.BAD_REQUEST),
	USER_PROVIDER_FORBIDDEN(38003, Status.FORBIDDEN),

	OIDC_USER_PROVIDER_DOMAIN_DISCRIMINATOR_ALREADY_EXISTS(38100, Status.BAD_REQUEST),
	...
	ACCOUNT_QUOTA_CANNOT_GET(46005, Status.FORBIDDEN),
	...
	STATISTIC_DATE_RANGE_ERROR(51010, Status.BAD_REQUEST),
	...
	GROUP_PROVIDER_NOT_FOUND(55001,Status.NOT_FOUND),
	GROUP_LDAP_PATTERN_CANNOT_BE_UPDATED(55002, Status.FORBIDDEN),
	GROUP_LDAP_PATTERN_CANNOT_BE_REMOVED(55003, Status.FORBIDDEN),


	WORKSPACE_LDAP_FILTER_NOT_FOUND(55004,Status.BAD_REQUEST),
	WORKSPACE_LDAP_FILTER_CANNOT_BE_REMOVED(55005, Status.FORBIDDEN),
	WORKSPACE_LDAP_FILTER_CANNOT_BE_UPDATED(55006, Status.FORBIDDEN),
	...
	THUMBNAIL_NOT_FOUND(58000, Status.NOT_FOUND),

	DOCUMENT_NOT_FOUND(59000, Status.NOT_FOUND),

	GROUP_PROVIDER_UNSUPPORTED_TYPE(63000, Status.BAD_REQUEST),
	GROUP_PROVIDER_FORBIDDEN(63001, Status.FORBIDDEN),
	GROUP_PROVIDER_ALREADY_EXIST(63002, Status.BAD_REQUEST),

	WORKSPACE_PROVIDER_UNSUPPORTED_TYPE(64000, Status.BAD_REQUEST),
	WORKSPACE_PROVIDER_FORBIDDEN(64001, Status.FORBIDDEN),
	WORKSPACE_PROVIDER_ALREADY_EXIST(64002, Status.BAD_REQUEST),
	WORKSPACE_PROVIDER_NOT_FOUND(64004,Status.NOT_FOUND),

	TWAKE_CONNECTION_ERROR(65000, Status.INTERNAL_SERVER_ERROR),
	TWAKE_REQUEST_ERROR(65001, Status.INTERNAL_SERVER_ERROR),

	USER_PROFILE_INCOMPATIBLE_ACCOUNT_TYPES(67000, Status.BAD_REQUEST),
	USER_PROFILE_ONLY_LOCALE_CAN_BE_MODIFIED(67001, Status.BAD_REQUEST),

	AUDIT_LOG_ENTRY_DO_NOT_EXIST(69404, Status.NOT_FOUND),

	FAVOURITE_RECIPIENT_NOT_FOUND(68000, Status.BAD_REQUEST);
