...
public enum BusinessErrorCode implements ErrorCode {
	...
	UPLOAD_REQUEST_NOT_FOUND(30000, Status.NOT_FOUND),
	UPLOAD_REQUEST_ENTRY_NOT_FOUND(30001, Status.NOT_FOUND),
	...
	UPLOAD_REQUEST_READONLY_MODE(30005, Status.BAD_REQUEST);
