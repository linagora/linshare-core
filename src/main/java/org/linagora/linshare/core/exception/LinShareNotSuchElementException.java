...
public class LinShareNotSuchElementException extends BusinessException {
	...
	public LinShareNotSuchElementException(String message,Throwable cause) {
		this(BusinessErrorCode.NO_SUCH_ELEMENT,message,cause);
	}


	@Deprecated
	public LinShareNotSuchElementException(BusinessErrorCode errorCode,
			String message) {
