...
public class WorkGroupDocumentServiceImpl extends WorkGroupNodeAbstractServiceImpl
	...
	@Override
	public InputStream getThumbnailStream(Account actor, Account owner, Thread workGroup, WorkGroupDocument node, ThumbnailKind thumbnailKind) throws BusinessException {
		return documentEntryBusinessService.getThreadEntryThumbnailStream(node, thumbnailKind);
	}
