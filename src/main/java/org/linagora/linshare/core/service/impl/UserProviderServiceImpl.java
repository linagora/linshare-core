...
public class UserProviderServiceImpl implements UserProviderService {
    ...
    public User findUser(LdapUserProvider userProvider, String mail) throws BusinessException, NamingException, IOException {
    	return ldapQueryService.findUser(userProvider.getLdapconnexion(), userProvider.getBaseDn(), userProvider.getPattern(), mail);
    }
	...
	public Boolean isUserExist(LdapUserProvider userProvider, String mail) throws BusinessException, NamingException, IOException {
    	return ldapQueryService.isUserExist(userProvider.getLdapconnexion(), userProvider.getBaseDn(), userProvider.getPattern(), mail);
	}
