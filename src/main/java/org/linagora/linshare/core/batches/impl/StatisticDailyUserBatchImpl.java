...
public class StatisticDailyUserBatchImpl extends GenericBatchImpl {
	...
	public StatisticDailyUserBatchImpl(final UserService userService,
			...
			AccountRepository<Account> accountRepository,final BatchHistoryBusinessService batchHistoryBusinessService) {
...
//		BatchHistory batchHistory = new BatchHistory(BatchType.DAILY_USER_BATCH);
