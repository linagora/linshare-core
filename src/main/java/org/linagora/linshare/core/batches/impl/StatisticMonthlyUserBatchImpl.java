...
public class StatisticMonthlyUserBatchImpl extends GenericBatchImpl {
	...
	public StatisticMonthlyUserBatchImpl(final UserWeeklyStatBusinessService userWeeklyStatBusinessService,
			final UserMonthlyStatBusinessService userMonthlyStatBusinessService, final UserService userService,
...
//		BatchHistory batchHistory = new BatchHistory(BatchType.MONTHLY_USER_BATCH);
...
//		}
	...
	public boolean needToRun() {
		return !batchHistoryBusinessService.exist(getFirstDayOfMonth(), new Date(), BatchType.MONTHLY_USER_BATCH);
	}
}
