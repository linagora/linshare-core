...
public class UploadRequestWarnExpiryEmailBuilder extends GenericUploadRequestEmailBuilder {
	...
	protected MailContainerWithRecipient buildMailContainer(EmailContext context) throws BusinessException {
		UploadRequestWarnExpiryEmailContext emailCtx = (UploadRequestWarnExpiryEmailContext) context;
