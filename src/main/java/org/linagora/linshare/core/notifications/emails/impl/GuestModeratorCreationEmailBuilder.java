...
public class GuestModeratorCreationEmailBuilder extends EmailBuilder {
	...
	protected MailContainerWithRecipient buildMailContainer(EmailContext context) throws BusinessException {
		GuestModeratorCreationEmailContext emailCtx = (GuestModeratorCreationEmailContext) context;
	...
	protected List<Context> getContextForFakeBuild(Language language) {
		...
		ctx.setVariable("role", ModeratorRole.ADMIN);
