...
public class UploadRequestClosedByRecipientEmailBuilder extends GenericUploadRequestEmailBuilder {
	...
	protected MailContainerWithRecipient buildMailContainer(EmailContext context) throws BusinessException {
		UploadRequestClosedByRecipientEmailContext emailCtx = (UploadRequestClosedByRecipientEmailContext) context;
