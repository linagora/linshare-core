...
public class GuestModeratorDeletionEmailBuilder extends EmailBuilder {
	...
	protected MailContainerWithRecipient buildMailContainer(EmailContext context) throws BusinessException {
		GuestModeratorDeletionEmailContext emailCtx = (GuestModeratorDeletionEmailContext) context;
