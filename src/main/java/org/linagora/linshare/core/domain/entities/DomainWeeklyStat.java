...
public class DomainWeeklyStat extends DomainStatistic {

	public DomainWeeklyStat() {
		super();
	}

	public DomainWeeklyStat(AbstractDomain domain, AbstractDomain parentDomain, Long operationCount,
		...
		super(domain, parentDomain, actualOperationSum, operationCount, deleteOperationCount, addOperationCount,
				addOperationSum, deleteOperationSum, diffOperationSum, StatisticType.DOMAIN_WEEKLY_STAT);
	}

	@Override
	public StatisticType getStatisticType() {
		return StatisticType.DOMAIN_WEEKLY_STAT;
	}
}
