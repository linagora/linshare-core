...
public class DomainDailyStat extends DomainStatistic {

	public DomainDailyStat() {
		super();
	}

	public DomainDailyStat(AbstractDomain domain, AbstractDomain parentDomain, Long operationCount,
		...
		super(domain, parentDomain, actualOperationSum, operationCount, deleteOperationCount, addOperationCount,
				addOperationSum, deleteOperationSum, diffOperationSum, StatisticType.DOMAIN_DAILY_STAT);
	}

	@Override
	public StatisticType getStatisticType() {
		return StatisticType.DOMAIN_DAILY_STAT;
	}
}
