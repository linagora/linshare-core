...
public class ThreadWeeklyStat extends AccountStatistic {

	public ThreadWeeklyStat(){
		super();
	}

	public ThreadWeeklyStat(Thread thread, AbstractDomain domain, AbstractDomain parentDomain, Long operationCount,
