...
public class ThreadDailyStat extends AccountStatistic {

	public ThreadDailyStat() {
		super();
	}

	public ThreadDailyStat(WorkGroup workGroup, AbstractDomain domain, AbstractDomain parentDomain, Long operationCount,
