...
public interface GenericAsyncFacade {
	...
	AsyncTaskDto processing(TaskContext taskContext,
			String asyncTaskUuid);

	AsyncTaskDto success(TaskContext taskContext, String asyncTaskUuid,
			String resourceUuid);

	AsyncTaskDto fail(TaskContext taskContext, String asyncTaskUuid,
			String errorMsg);
