...
public class SharedSpacePermissionFacadeImpl extends AdminGenericFacadeImpl implements SharedSpacePermissionFacade {

	private final SharedSpacePermissionService ssPermissionService;

	public SharedSpacePermissionFacadeImpl(AccountService accountService,
			SharedSpacePermissionService ssPermissionService) {
		super(accountService);
		this.ssPermissionService = ssPermissionService;
	}
	...
	public List<SharedSpacePermission> findAll() throws BusinessException {
		Account authUser = checkAuthentication(Role.SUPERADMIN);
		return ssPermissionService.findAll(authUser, authUser);
	}
