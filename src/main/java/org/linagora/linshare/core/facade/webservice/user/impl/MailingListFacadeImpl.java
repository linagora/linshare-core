...
public class MailingListFacadeImpl extends GenericFacadeImpl implements MailingListFacade {
	...
	@Override
	public Set<MailingListContactDto> findAllContacts(String ownerUuid, String listUuid, boolean v2) throws BusinessException {
		...
		if (v2) {
			return ImmutableSet.copyOf(Lists.transform(list, MailingListContactDto.toDtoV2()));
		}
	...
	public MailingListContactDto addContact(String ownerUuid, String listUuid, MailingListContactDto dto) throws BusinessException {
		...
		return new MailingListContactDto(contact2, true);
	}
