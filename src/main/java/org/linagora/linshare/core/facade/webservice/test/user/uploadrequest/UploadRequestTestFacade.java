...
package org.linagora.linshare.core.facade.webservice.test.user.uploadrequest;

import java.util.List;

import org.linagora.linshare.core.facade.webservice.test.user.uploadrequest.dto.UploadRequestDto;

public interface UploadRequestTestFacade {

	List<UploadRequestDto> findAllUploadRequestsURl(String actorUuid, String groupUuid);
}