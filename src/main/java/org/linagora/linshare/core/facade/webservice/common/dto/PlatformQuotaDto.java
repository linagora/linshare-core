...
@XmlRootElement
@ApiModel
public class PlatformQuotaDto extends QuotaDto {

	public PlatformQuotaDto() {
	}

	public PlatformQuotaDto(PlatformQuota platformQuota) {
		super(platformQuota);
	}
	...
	public PlatformQuota toUserObject() {
		...
		platformQuota.setQuotaWarning(getQuotaWarning());
