...
public interface UserAutoCompleteFacade {
	 ...
	 /**
     * 
     * @param currentUser: actorVo.
     * @param pattern: pattern used to perform the search.  could be mail, first name or last name fragment, 
     * @return
     * @throws BusinessException
     */
    List<UserVo> autoCompleteUser(UserVo currentUserVo, String pattern) throws BusinessException;
