...
public interface DomainPatternFacade extends AdminGenericFacade {
	...
	List<DomainPatternDto> findAll() throws BusinessException;

	DomainPatternDto find(String uuid) throws BusinessException;

	List<DomainPatternDto> findAllModels() throws BusinessException;
