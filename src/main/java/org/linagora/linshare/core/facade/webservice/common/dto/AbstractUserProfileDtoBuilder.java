...
public abstract class AbstractUserProfileDtoBuilder<T extends AbstractUserProfileDto> {
	...
	public AbstractUserProfileDtoBuilder<T> firstName(String firstName) {
		this.firstName = firstName;
		return this;
	}

	public AbstractUserProfileDtoBuilder<T> lastName(String lastName) {
		this.lastName = lastName;
		return this;
	}

	public AbstractUserProfileDtoBuilder<T> mail(String mail) {
		this.mail = mail;
		return this;
	}

	public AbstractUserProfileDtoBuilder<T> creationDate(Date creationDate) {
		this.creationDate = creationDate;
		return this;
	}

	public AbstractUserProfileDtoBuilder<T> modificationDate(Date modificationDate) {
		this.modificationDate = modificationDate;
		return this;
	}

	public AbstractUserProfileDtoBuilder<T> locale(UserLanguage locale) {
		this.locale = locale;
		return this;
	}

	public AbstractUserProfileDtoBuilder<T> personalSpaceEnabled(boolean personalSpaceEnabled) {
