...
public class TimeUnitDefaultParameterDto extends ParameterDto<Integer> {
	...
	public TimeUnitDefaultParameterDto(boolean hidden, boolean readonly, Optional<NestedUnitParameterDto<?>> defaut) {
		super(hidden, readonly, defaut.get());
	}

	@Override
	public String toString() {
		return "TimeUnitDefaultParameterDto [hidden=" + hidden + ", readonly=" + readonly + ", defaut=" + defaut
				+ "]";
	}
