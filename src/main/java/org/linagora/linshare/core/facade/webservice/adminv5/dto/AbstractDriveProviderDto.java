...
@JsonSubTypes({
	@Type(value = LDAPDriveProviderDto.class, name="LDAP_PROVIDER")
})
public abstract class AbstractDriveProviderDto {

	@Schema(description = "DriveProvider's uuid", required = false)
	protected String uuid;

	@Schema(description = "DriveProvider's creation date", required = false)
	protected Date creationDate;

	@Schema(description = "DriveProvider's modification date", required = false)
	protected Date modificationDate;

	@Schema(description = "DriveProvider's domain", required = false)
	...
	public AbstractDriveProviderDto(DriveProvider driveProvider) {
		...
		this.modificationDate = driveProvider.getModificationDate();
		this.domain = new DomainLightDto(driveProvider.getDomain());
		this.type = driveProvider.getType();
	}
	...
	public String toString() {
		return "AbstractDriveProviderDto [uuid=" + uuid + ", domain=" + domain + ", type=" + type + "]";
	}
}
