...
public interface OperationHistoryRepository extends AbstractRepository<OperationHistory> {
	...
	Long sumOperationValue(Account account, AbstractDomain domain, Date creationDate, OperationHistoryTypeEnum operationType);

	Long countOperationValue(Account account, AbstractDomain domain, Date creationDate, OperationHistoryTypeEnum operationType);
