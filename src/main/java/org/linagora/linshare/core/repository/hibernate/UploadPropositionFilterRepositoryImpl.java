...
public class UploadPropositionFilterRepositoryImpl extends
	...
	protected DetachedCriteria getNaturalKeyCriteria(
			UploadPropositionFilterOLD entity) {
		DetachedCriteria det = DetachedCriteria.forClass(
				UploadPropositionFilterOLD.class).add(
	...
	public UploadPropositionFilterOLD find(String uuid) {
		List<UploadPropositionFilterOLD> entries = findByCriteria(Restrictions.eq(
				"uuid", uuid));
		return DataAccessUtils.singleResult(entries);
	}

	@Override
	public UploadPropositionFilterOLD create(UploadPropositionFilterOLD entity)
	...
	@Override
	public UploadPropositionFilterOLD update(UploadPropositionFilterOLD entity)
			throws BusinessException {
		entity.setModificationDate(new Date());
