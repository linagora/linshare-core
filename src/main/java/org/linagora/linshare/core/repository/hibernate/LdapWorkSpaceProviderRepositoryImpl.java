...
public class LdapWorkSpaceProviderRepositoryImpl extends AbstractRepositoryImpl<LdapWorkSpaceProvider> implements LdapWorkSpaceProviderRepository {

	public LdapWorkSpaceProviderRepositoryImpl(HibernateTemplate hibernateTemplate) {
