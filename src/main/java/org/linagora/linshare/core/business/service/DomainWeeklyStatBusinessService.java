...
public interface DomainWeeklyStatBusinessService {

	DomainWeeklyStat create(AbstractDomain domain, Date beginDate, Date endDate);

	List<DomainWeeklyStat> findBetweenTwoDates(AbstractDomain domain, Date beginDate, Date endDate);
