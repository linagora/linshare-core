...
public class UploadRequestHistoryBusinessServiceImpl implements
	...
	public UploadRequestHistory findByUuid(String uuid) {
		return uploadRequestHistoryRepository.findByUuid(uuid);
	}

	@Override
	public UploadRequestHistory create(UploadRequestHistory hist)
			throws BusinessException {
		return uploadRequestHistoryRepository.create(hist);
	}

	@Override
	public UploadRequestHistory update(UploadRequestHistory hist)
			throws BusinessException {
