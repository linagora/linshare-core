...
public class AsyncTaskBusinessServiceImpl implements AsyncTaskBusinessService {
	...
	public AsyncTaskBusinessServiceImpl(AsyncTaskRepository repository) {
		super();
		this.repository = repository;
	}

	@Override
	public AsyncTask find(String uuid) {
		return repository.findByUuid(uuid);
	}

	@Override
	public void delete(AsyncTask asyncUploadStatus) throws BusinessException {
		repository.delete(asyncUploadStatus);
	}

	@Override
	public AsyncTask update(AsyncTask asyncUploadStatus)
			throws BusinessException {
		return repository.update(asyncUploadStatus);
	}
