...
public interface UserWeeklyStatBusinessService {

	UserWeeklyStat create(User user, Date beginDate, Date endDate);

	List<UserWeeklyStat> findBetweenTwoDates(User user, Date beginDate, Date endDate);
