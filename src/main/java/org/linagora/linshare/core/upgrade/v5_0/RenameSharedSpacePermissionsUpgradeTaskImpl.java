...
public class RenameSharedSpacePermissionsUpgradeTaskImpl extends GenericUpgradeTaskImpl {

	private final MongoTemplate mongoTemplate;

	public RenameSharedSpacePermissionsUpgradeTaskImpl(
	...
	public UpgradeTaskType getUpgradeTaskType() {
		return UpgradeTaskType.UPGRADE_5_0_RENAME_SHARED_SPACE_PERMISSIONS;
	}
	...
	public void notify(BatchRunContext batchRunContext, ResultContext context, long total, long position) {
		...
		if (res.getProcessed()) {
			logInfo(batchRunContext, total, position, "WORKGROUP in SharedSpacePermission was renamed successfully to WORK_GROUP.");
		}
	}
	...
	public void notifyError(BatchBusinessException exception, String identifier, long total, long position, BatchRunContext batchRunContext) {
		...
		logger.error("Error occurred while renaming WORKGROUP in SharedSpacePermission", exception);
	}
