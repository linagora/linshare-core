...
@Import(library = {"../../../components/jquery/jquery-1.7.2.js","../../../components/jquery/jquery.ui.core.js","../../../components/jquery/jquery.ui.widget.min.js","../../../components/jquery/jquery.ui.mouse.min.js","../../../components/jquery/jquery.ui.sortable.min.js","CreateDomainPolicy.js"}, stylesheet={"../../../components/jquery/jquery-ui-1.8.21.custom.css","CreateDomainPolicy.css"})
public class CreateDomainPolicy {
    ...
    public List<DomainAccessRule> getRules(){
    	return domainPolicy.getDomainAccessPolicy().getRules(); 
    	}
	...
	public void init() {
		if (domainPolicy == null) {
			...
			domainPolicy.setIdentifier(null);
			domainPolicy.setPolicyDescription("");
			domainPolicy.setDomainAccessPolicy(null);
		}
   ...
   /* public Object onActionFromAddRule() {
	...
	public Object onSuccess() {
		...
		try {
			if (inModify) {
				...
				domainFacade.createDomainPolicy(loginUser,domainPolicy);
				}
		} catch (BusinessException e) {
			logger.error("Can not create or update domain policy : " + e.getMessage());
