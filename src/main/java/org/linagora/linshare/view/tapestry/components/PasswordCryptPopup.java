 ...
 *
 */
public class PasswordCryptPopup {
    ...
    private WindowWithEffects window_passwordCryptPopup;
	...
	public Zone formFail() {
		message = messages.get("components.listDocument.passwordCryptPopup.error.message");
		return formZone;
	}
	...
	public String getJSONId() {
		return window_passwordCryptPopup.getJSONId();
	}
