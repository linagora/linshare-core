...
public class MailTemplating implements Templating {
	...
	public String getMessage(InputStream template,
	...
	public String getMessage(String templateContent,
			Map<String, String> parameters) {
		Set<Map.Entry<String, String>> params = parameters.entrySet();

		for (Map.Entry<String, String> entry : params) {
			templateContent = StringUtils.replace(templateContent,
	...
	public String readFullyTemplateContent(InputStream template) {
		...
		try {
			...
			throw new TechnicalException(TechnicalErrorCode.MAIL_EXCEPTION,
					"The template is not valid", e);
		} catch (Exception ex) {
			throw new TechnicalException(TechnicalErrorCode.MAIL_EXCEPTION,
					"The template is not valid", ex);
		}
		return content;
	}
}
