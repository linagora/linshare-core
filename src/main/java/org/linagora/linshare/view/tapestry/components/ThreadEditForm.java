...
//    private WindowWithEffectsComponent threadEditWindow;
//    
//    @InjectComponent
...
//		try {
//			threadName = filter.clean(threadName);
//			if (filter.hasError()) {
...
//
//        try {
//			threadEntryFacade.renameThread(userLoggedIn, editThreadWithUuid, threadName);
//		} catch (BusinessException e) {
//			logger.error("Unable to rename the thread" + e.getMessage());
//		}
...
//    	return threadEditWindow.getJSONId();
//    }
//    
//    /**
...
//    	return threadEditWindow.getJavascriptOpenPopup();
//    }
//    
...
//		this.editThreadWithUuid = uuid;
//		initFormToEdit();
//	}
//	
//    private void initFormToEdit(){
//		if(editThreadWithUuid != null) {
//	    	ThreadVo thread;
//			try {
//				threadName = cuthread.getName();
//			} catch (BusinessException e) {
