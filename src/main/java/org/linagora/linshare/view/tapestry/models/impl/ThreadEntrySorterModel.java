...
public class ThreadEntrySorterModel implements SorterModel<ThreadEntryVo>{
	...
	public ThreadEntrySorterModel(List<ThreadEntryVo> listToSort){
	 ...
	 * 
	 */
	public Comparator<ThreadEntryVo> getComparator(String fieldId) {
		if(DATE_FIELD.equals(fieldId)){
			return new Comparator<ThreadEntryVo>(){
