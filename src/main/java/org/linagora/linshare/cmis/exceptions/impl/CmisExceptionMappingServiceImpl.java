...
public class CmisExceptionMappingServiceImpl implements
		CmisExceptionMappingService {

	@Override
	public CmisBaseException map(BusinessException businessException) {
		CmisBaseException exception;
		switch (businessException.getErrorCode()) {
		case CANNOT_DELETE_SHARED_DOCUMENT:
			exception = new CmisPermissionDeniedException(
