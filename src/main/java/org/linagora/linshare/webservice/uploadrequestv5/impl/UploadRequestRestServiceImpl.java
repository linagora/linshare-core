...
import org.linagora.linshare.webservice.uploadrequestv5.UploadRequestRestService;
...
public class UploadRequestRestServiceImpl implements UploadRequestRestService{
	...
	protected static final Logger logger = LoggerFactory.getLogger(UploadRequestRestServiceImpl.class);
	...
	@Operation(summary = "Download a choosen upload request entry.", responses = {
		@ApiResponse(
			content = @Content(schema = @Schema(implementation = ByteSource.class)),
			responseCode = "200"
		)
	})
	@Override
