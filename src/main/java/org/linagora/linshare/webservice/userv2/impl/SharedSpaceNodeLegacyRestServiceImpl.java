...
@Api(value = "/rest/user/v2/shared_space_nodes", description = "sharedspacenodes service.deprecated see sharedspaces service", produces = "application/json,application/xml", consumes = "application/json,application/xml")
