...
import org.linagora.linshare.webservice.userv1.LogRestService;
...
public class LogRestServiceImpl extends org.linagora.linshare.webservice.userv1.impl.LogRestServiceImpl
		implements LogRestService {

	public LogRestServiceImpl(final LogEntryFacade logEntryFacade) {
		super(logEntryFacade);
	}
}
