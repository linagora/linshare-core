...
public class AuthenticationRestServiceImpl extends WebserviceBase implements AuthenticationRestService {
	...
	public AuthenticationRestServiceImpl(final UploadPropositionGenericFacade uploadPropositionGenericFacade) {
	...
	public UserDto isAuthorized() throws BusinessException {
		return UserDto.getFull(uploadPropositionGenericFacade.checkAuthentication());
	}
