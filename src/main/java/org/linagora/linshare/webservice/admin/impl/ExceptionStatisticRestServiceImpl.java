...
@Path("/exceptionStatistic")
@Api(value = "/rest/admin/exceptionStatistic", description = "exceptionStatistic service.", produces = "application/json,application/xml", consumes = "application/json,application/xml")
