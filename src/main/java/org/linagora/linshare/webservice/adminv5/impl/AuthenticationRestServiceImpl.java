...
import org.linagora.linshare.webservice.adminv5.AuthenticationRestService;
...
public class AuthenticationRestServiceImpl extends WebserviceBase implements AuthenticationRestService {
	...
	protected AuthenticationRestServiceImpl(
			UserFacade userFacade,
			SecondFactorAuthenticationFacade secondFactorAuthenticationFacade) {
		super();
	...
	@Path("/")
	@GET
	@Operation(summary = "No operation, it is used for redirection after the user's logging out")
	@Override
	public void noop() {
		return; // do nothing
	}
	...
	@GET
	@Operation(
			summary = "Check if user is authorized to login.",
			responses = {
					@ApiResponse(
	...
	@Path("/version")
	@GET
	@Operation(summary = "Get core's version")
	@Override
	...
	@Override
	public SecondFactorDto create2FA(SecondFactorDto secondFactorDto) {
		return secondFactorAuthenticationFacade.create(secondFactorDto);
	}
	...
	public SecondFactorDto delete2FA(
			...
			@Parameter(description = "Optional 2FA object to delete.", required = true)
				SecondFactorDto secondFactorDto) {
		return secondFactorAuthenticationFacade.delete(uuid, secondFactorDto);
	}
}
