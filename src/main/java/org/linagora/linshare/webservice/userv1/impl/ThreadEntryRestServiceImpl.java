...
public class ThreadEntryRestServiceImpl extends WebserviceBase implements
	...
	public WorkGroupEntryDto create(
		...
		if (async) {
			...
			try {
				...
				WorkGroupEntryTaskContext workGroupEntryTaskContext = new WorkGroupEntryTaskContext(authUserDto, authUserDto.getUuid(), threadUuid, tempFile, fileName, null, false);
	...
	public List<WorkGroupEntryDto> findAll(
		...
		List<WorkGroupNode> all = facade.findAll(null, threadUuid, null, true, Lists.newArrayList(WorkGroupNodeType.DOCUMENT));
